...
/**
 * Normalizes the `rules` property from a Next.js `MetadataRoute.Robots` object into an array.
 *
 * @description
 * The Next.js `MetadataRoute.Robots` rules field can be either a single rule object or an array
 * of rule objects. This helper guarantees a consistent array format for test assertions across
 * various user-agent rule definitions.
 *
 * @param {MetadataRoute.Robots} result - The robots configuration object generated by the `robots()` route handler.
 * @returns {Array<any>} An array of robot rules for uniform query and assertion in test suites.
 */
