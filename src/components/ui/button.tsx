  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        terminal:
          "border border-(--terminal-border) bg-(--terminal-bg) text-(--terminal-text) hover:border-(--terminal-accent) hover:bg-(--terminal-accent)/10 shadow-sm",
        "terminal-danger":
          "border border-red-500/40 bg-red-500/10 text-red-400 hover:border-red-500 hover:bg-red-500/20 shadow-sm",
      },
      size: {
