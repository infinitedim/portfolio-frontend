...
export function FeaturedProjectsClient({ projects }: FeaturedProjectsClientProps): JSX.Element {
  const { t } = useI18n();
  ...
  return (
    <section className="border-t border-neutral-800 px-4 py-16">
      <div className="mx-auto max-w-6xl">
        ...
        {projects.length === 0 ? (
          <p className="font-mono text-sm text-neutral-500">{t("projectsNone")}</p>
        ) : (
