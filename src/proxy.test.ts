...
describe("proxy", () => {
  ...
  describe("security headers", () => {
    ...
    it("sets PPR-compatible CSP without strict-dynamic", () => {
      const result = proxy(mockRequest);
  ...
  describe("device detection", () => {
    it("should handle desktop device", () => {
      ...
      const result = proxy(desktopRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
    ...
    it("should handle mobile device", () => {
      ...
      const result = proxy(mobileRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
    ...
    it("should handle tablet device", () => {
      ...
      const result = proxy(tabletRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
  });
  ...
  describe("browser detection", () => {
    it("should handle Chrome browser", () => {
      ...
      const result = proxy(chromeRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
    ...
    it("should handle Firefox browser", () => {
      ...
      const result = proxy(firefoxRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
    ...
    it("should handle Safari browser", () => {
      ...
      const result = proxy(safariRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
  });
  ...
  describe("cache optimization", () => {
    ...
    it("should handle static assets caching", () => {
      ...
      const result = proxy(staticRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
    ...
    it("should handle main pages caching", () => {
      ...
      const result = proxy(mainPageRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
  });
  ...
  describe("A/B testing", () => {
    ...
    it("should handle existing experiment variant cookie", () => {
      ...
      const result = proxy(requestWithCookie);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
  });
  ...
  describe("theme detection", () => {
    it("should handle dark theme preference", () => {
      ...
      const result = proxy(darkThemeRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
    ...
    it("should handle light theme preference", () => {
      ...
      const result = proxy(lightThemeRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
  });
  ...
  describe("suspicious request detection", () => {
    it("should handle suspicious requests with path traversal", () => {
      ...
      expect(() => proxy(suspiciousRequest)).not.toThrow();
    });
  ...
  describe("RUM setup", () => {
    it("should handle RUM for homepage", () => {
      ...
      const result = proxy(homepageRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
    ...
    it("should handle RUM for other pages", () => {
      ...
      const result = proxy(otherPageRequest);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("headers");
    });
  });
  ...
  describe("error handling", () => {
    it("should handle missing headers gracefully", () => {
      ...
      expect(() => proxy(minimalRequest)).not.toThrow();
    });
